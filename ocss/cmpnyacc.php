...
.b112 ul li a.active,.b112 ul li a:hover
{ 
color:black;
}
}
...
{
border:0px solid black;
background-image:url("img/client1 (2).jpeg");
background-size:cover;
width:100%;
height: 250px;
float:left;
...
<h1><span>O</span>NLINE <span>C</span>AMPUS <span>R</span>ECRUITMENT <span>S</span>YSTEM</h>
</header>
<nav>
<ul>
<li><a href="index.php">Home</a></li>
<li><a href="#">View Posted Job</a></li>
...
<form action="" method="post" onsubmit="return validation()"onkeyup="myfunction()">
			<br>
			<label for="name">UserName:</label>
			<input type="text" name="name1" id="name" placeholder="name" size="15">
			<span id="ername"></span><br><br>
			<label for="pass">Password:</label>
			&nbsp;&nbsp;<input type="text" name="pass1" id="pass" placeholder="password" size="15">
			<span id="erpass"></span>
			<br><br>
...
//$stdcon=mysqli_connect("localhost","root","","project") or die("Not connectd");
if(isset($_POST['sub1'])){
	$name=$_POST['name2'];
	$pass=$_POST['pass2'];

$r=mysqli_query($con,"select * from `cmpreg` where uname='$name' AND pass='$pass'") or mysqli_error();
$sd=mysqli_num_rows($r);
if($sd>'0'){
	echo "Login Success";
	$_SESSION['ee']=$name;
...
<select>
<option selected disabled hidden>----To Choose Here----</option>
<option>SC</option>
<option>ST</option>
...
<div class="b112">
<ul type="none">
<li><a href="#">viewprofile</a></li>
<li><a href="cmpnychangepass.php">ChangePass</a></li>
<li><a href="cmpdelete.php">RemoveAccount</a></li>
</ul>
</div>
</center>
</div>
