...
<div class="c22">
			...
			<input type="text" name="pass" id="pass" placeholder="password" size="15">
			<span id="erpass"></span>
			<br><br>
            <input type="submit" name="submit" value="Login" class="but3">
...
<td><input type="phone" name="telphone" placeholder="Enter your num" maxlength="10" id="contact" required>
</td>
</tr>
<tr>
<td><br></td>
...
<tr>
<td><input type="Submit" name="sub" value="View Password"></td>
</tr>
</table>
</form>
</center>
