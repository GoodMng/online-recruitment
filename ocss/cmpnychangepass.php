...
<div class="a33">
<ul>
<li><a href="nsr.html">NewStudent ?</a></li>
<li><a href="stdfpass.html">ForgotPassword ?</a></li>
</ul>
</div>
</div>
</div>
...
<div class="b1">
<h1 align="center">::COMPANY CHANGE PASSWORD::</h1>
<div class="b12">
<form action="" method="post" onsubmit="return validation()">
			<table>
                        <tr><td><label for="pass">CurentPassword:</label></td>
			<td><input type="text" name="pass" id="pass" placeholder="password" autocomplete="off" size="15"></td>
			<td><span id="erpass"></span></td></tr>
                        <tr><td></td></tr>
                        <tr><td></td></tr>
                       <tr><td><label for="npass">NewPassword:</label></td>
			<td><input type="text" name="pass" id="npass" placeholder="password" autocomplete="off" size="15"></td>
			<td><span id="ernpass"></span></td>
                        </tr>
                        <tr><td></td></tr>
                        <tr><td></td></tr>
                        <tr><td>
                        <label for="cpass">ConfirmPassword:</label></td>
			<td><input type="text" name="pass" id="cpass" placeholder="password" autocomplete="off"size="15"></td>
			<td><span id="ercpass"></span></td>
                        </tr>
                        <tr><td></td></tr>
                        <tr><td></td></tr>
                        <tr><td></td></tr>
            ...
            <input type="submit" name="submit" value="Submit" class="but3">
<input type="submit" name="reset" value="Cancel" class="but3">
            </form>
