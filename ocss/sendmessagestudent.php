...
<li><a href="nsr.php">Student details</a></li>
...
<div class="b1">
<h1 align="center">SEND MESSAGE TO STUDENT::@abc@gmail.com</h1>
<div class="b12">
<form action="" method="post" onsubmit="return validation()">
			<br>
                        <label for="pass">Name/Email Id:</label>
			<input type="Email" name="pass" id="pass" placeholder="Email" autocomplete="off" size="15">
			<span id="erpass"></span><br><br>
                       
                       <label for="npass">Message:</label>
			<textarea name="pass" id="tarea" placeholder="Message" autocomplete="off" rows="3" cols="15"></textarea>
			<span id="ernpass"></span><br><br>
                        
                        
            <input type="submit" name="submit" value="Send" class="but3">
